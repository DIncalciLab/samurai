process ASSEMBLE_GISTIC_OUTPUT {
    ...
    gistic gene-table ${args} ${gistic_folder} gistic
    gistic copy-number-state-table ${args} ${gistic_folder} gistic_cn_states.txt
    gistic log2ratio-table ${args} ${gistic_folder} gistic_log2R.txt
