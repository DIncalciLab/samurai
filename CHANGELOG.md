...
## v1.5.0 - "Date Masamune" (2026-07-07)

This release introduces two notable features:

- Additional quality control metrics as implemented in the [CINMetrics package](https://github.com/lasseignelab/CINmetrics) by [Oza and coworkers](https://pubmed.ncbi.nlm.nih.gov/37123011/)
- Additional plots generated from WisecondorX data, which should be clearer and more readable than the ones autogenerated by the application (which are still available should you need them)

There is **one breaking change**: `--ichorcna_ploidy_aware_plot` was removed and it is now done unconditionally, as the impact on the pipeline was minimal and added unnecessary complexity.

Lastly, this release introduces a workaround to allow ichorCNA analyses without a panel of normals to proceeed correctly.

This release is named after Date Masamune (伊達政宗; 1567-1636), a powerful feudal lord of the late "Warring States" period and the early Edo period in medieval Japan, who ruled over Sendai. Due to a missing eye (lost to smallpox as a child), he was often called "dokuganryu" (独眼竜) or "one-eyed dragon".

## Breaking changes

- `--ichorcna_ploidy_aware_plot` was removed (@SaraPotente, 932308a9b1bd461a87e4bd4c066e0cb4b0a6bd32)

## New features

- Support the CINMetrics package (@SaraPotente, PR #64) with additional QC metrics
- Generate additional WisecondorX plots in the same style as ichorCNA (@SaraPotente, PR #66)

## Bug fixes

- Workaround pipeline hangs when running ichorCNA without a panel of normals (@lbeltrame, 1812febb73d021f105e9e77362cfc9afad924355, 58168a36ad521b224b6a9f89f89a6f4785b9c20b and 6125ce3f89ba36531e51afc3f87e7fb9e9bbd549)
